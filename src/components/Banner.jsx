    ...
    >
      <SwiperSlide>
        <div className='w-full h-[250px] md:h-[350px] lg:h-[500px] relative overflow-hidden'>
          ...
          <p className='md:text-3xl lg:text-5xl font-bold lg:leading-20 text-[#8B5E3C] absolute top-1 left-10 md:top-10 md:left-16 lg:top-20 lg:left-20'>Find Your Furry Friend Today!</p>
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide>
        <div className='w-full h-[250px] md:h-[350px] lg:h-[500px] '>
          ...
          <p className='absolute  lg:right-20 right-8 md:right-16 lg:bottom-10 bottom-6 md:text-3xl lg:text-5xl lg:leading-16 text-white text-bold'>Adopt, Don’t Shop <br /> Give a Pet a Home.</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='w-300px lg:w-full md:h-[350px] h-[250px] lg:h-[500px] '>
          ...
          <p className='absolute lg:left-20 left-8 md:left-16 lg:top-10  md:text-3xl lg:text-5xl lg:leading-16 lg:text-white text-amber-600 text-bold'>Because Every Pet <br />Deserves Love and Care.</p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='w-300px lg:w-full md:h-[350px] h-[250px] lg:h-[500px] '>
          ...
          <p className='absolute lg:right-20 right-8 md:right-16 lg:top-24 bottom-6 md:text-3xl lg:text-5xl lg:leading-16 lg:text-white text-amber-600 text-bold'>CARE PRODUCTS</p>
        </div>
      </SwiperSlide>
    </Swiper>
  );
