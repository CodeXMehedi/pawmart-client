...
const CareProducts = () => {
    ...
    useEffect(() => {
      fetch('https://pawmart-server-beta.vercel.app/services?category=Care Products')
        .then(res => res.json())
  ...
  return (
    <>
      <Navbar></Navbar>
      <h1 className='text-bold text-[#0B6623] text-4xl text-center my-6'>Care Products Collection</h1>
